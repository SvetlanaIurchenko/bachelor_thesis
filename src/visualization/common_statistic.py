...
def make_common_statistic_plots(report_folder, r_s_final, r_s_new_final, y1, y2):
    create_box_plot_with_hue(report_folder, r_s_new_final[r_s_new_final.mice_age == '8m'].loc[r_s_new_final[r_s_new_final.mice_age == '8m']['series'] != 'CTRL']
                             , 'series', y1, 'mice_type', **{'plotname': y1 + ' 7-8 m.o.'})
    create_box_plot_with_hue(report_folder, r_s_new_final[r_s_new_final.mice_age == '4m'].loc[r_s_new_final[r_s_new_final.mice_age == '4m']['series'] != 'CTRL']
                             , 'series', y1, 'mice_type', **{'plotname': y1 + ' 3-4 m.o.'})
    create_box_plot_with_hue(report_folder, r_s_final.loc[r_s_final['series'] == 'CTRL']
                             ,'mice_type', y2, 'mice_age', **{'plotname': y2 + ' CTRL series'})
...
def electric_parameters_group_common_statistic(report_folder, files, colors):
    ...
    make_common_statistic_plots(report_folder, r_s_final, r_s_new_final, 'delta_R_s', 'R_s')
    create_result_table_statistic_tests(report_folder, r_s_final, 'R_s', **{'plotname': 'stat_tests_for_r_s'})
    ...
    make_common_statistic_plots(report_folder, r_in_final, r_in_new_final, 'delta_R_in', 'R_in')
    create_result_table_statistic_tests(report_folder, r_in_final, 'R_in', **{'plotname': 'stat_tests_for_r_in'})
...
def baseline_analysis_group_common_statistic(report_folder, files, colors):
    ...
    make_common_statistic_plots(report_folder, i_h_final, i_h_new_final, 'delta_I_h', 'I_h')
    ...
    make_common_statistic_plots(report_folder, i_noise_final, i_noise_new_final, 'delta_I_noise', 'I_noise')
...
def event_parameters_group_common_statistic(report_folder, files, colors):
    ...
    make_common_statistic_plots(report_folder, amplitudes_final, amplitudes_new_final, 'delta_amplitudes', 'amplitudes')
    make_common_statistic_plots(report_folder, tau_decay_final, tau_decay_new_final, 'delta_tau_decay', 'tau_decay')
    make_common_statistic_plots(report_folder, rise_rate_10_90_final, rise_rate_10_90_new_final, 'delta_rise_rate_10_90', 'rise_rate_10_90')
    ...
    make_common_statistic_plots(report_folder, spont_freqs_final, spont_freqs_new_final, 'delta_spont_freqs', 'spont_freqs')
